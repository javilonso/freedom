(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/material/button'), require('@angular/material/progress-bar'), require('@angular/material/progress-spinner'), require('@angular/material/core'), require('@angular/material/icon')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/material/button', '@angular/material/progress-bar', '@angular/material/progress-spinner', '@angular/material/core', '@angular/material/icon'], factory) :
    (factory((global.matProgressButtons = {}),global.ng.core,global.ng.common,null,null,null,null,null));
}(this, (function (exports,core,common,button,progressBar,progressSpinner,core$1,icon) { 'use strict';
    ...
    var MatSpinnerButtonComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        MatSpinnerButtonComponent.prototype.ngOnChanges = /**
         * @param {?} changes
         * @return {?}
         */
        function (changes) {
    ...
    var MatBarButtonComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        MatBarButtonComponent.prototype.ngOnChanges = /**
         * @param {?} changes
         * @return {?}
         */
        function (changes) {
